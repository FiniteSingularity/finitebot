...
@Component({
  selector: 'app-chalkboard-cheer',
  templateUrl: './chalkboard-cheer.component.html',
  styleUrls: ['./chalkboard-cheer.component.scss'],
  animations: [
    trigger('openClose', [
      state('open', style({
        width: '300px',
...
export class ChalkboardCheerComponent implements OnInit {
  @Input() msg: any;
  @Input() extraData: any;
  ...
  setupMessage(): void {
    ...
    const message1 = `${data.user_name} cheered`;
    const message2 = `${data.bits} bits!`
